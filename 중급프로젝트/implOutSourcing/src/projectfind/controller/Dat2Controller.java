 ...
 */
@WebServlet("/dat2.do")
public class Dat2Controller extends HttpServlet {
	private static final long serialVersionUID = 1L;
    public static int dat2 = 365;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Dat2Controller() {
        super();
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		int dat1 = Dat1Controller.dat1;
		 dat2 = Integer.parseInt(request.getParameter("dat2"));
