 ...
 */
@WebServlet("/bud1.do")
public class Bud1Controller extends HttpServlet {
	private static final long serialVersionUID = 1L;
    public static int bud1 = 0;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Bud1Controller() {
        super();
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		int bud1 = Integer.parseInt(request.getParameter("bud1"));
		 int bud2 = Bud2Controller.bud2;
