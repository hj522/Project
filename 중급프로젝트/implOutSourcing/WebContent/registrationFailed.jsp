				...
				<div class="w3-sidebar w3-bar-block w3-light-grey w3-card"
					...
					<div class="w3-dropdown-hover">
						...
						<div class="w3-dropdown-content w3-bar-block">
							<a href="./inspection.jsp" class="w3-bar-item w3-button">검수
								중</a> <a href="./temporaryStorage.jsp" class="w3-bar-item w3-button">임시
		...
		<div class="box">
			<div
				...
				<div style="font-size: 13pt; padding-top: 10px;">
					<b>등록되지 않은 프로젝트를 확인할 수 있습니다.</b><br>
				</div>
			</div>
			<hr>
			<br> <br>
			<div class="guideBox">
				...
				<p style="float: left; padding-left: 8px;">
					1. 검수 후 등록에 실패한 프로젝트의 목록입니다.<br> 2. 프로젝트의 내용,비용, 기간이 부적합하거나 임플
					이용약관에 위배되는 경우, 프로젝트가 등록되지 않습니다.<br> 3. 프로젝트를 다시 등록하려면 <strong>[다시
						등록하기]</strong> 버튼을 클릭해 주세요.<br>&nbsp;&nbsp;&nbsp;&nbsp;등록된 프로젝트는 검수 후에
					지원자 모집을 시작하며, 필요시 임플 매니저가 연락드릴 수 있습니다. <br>
				</p>
			</div>
				...
				<table class="summaryTable">
					...
					<tbody>
						<tr class="firstRow">
							...
							<td class="tableContent">300만</td>
							<td class="tableTitle">예상기간</td>
							<td class="tableContent">30일</td>
							<td class="tableTitle">등록 실패 일자</td>
							<td class="tableContent">2022년 9월 18일</td>
						</tr>
					</tbody>
				</table>
				<div class="managementTools">
					<a class="renewalProject" href="#" role="button" style="text-align: right;">다시 등록하기</a>
				</div>
			</div>
		</div>
	</form>
