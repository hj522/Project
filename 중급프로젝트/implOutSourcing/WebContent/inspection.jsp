...
<% 
	...
	if(msg.equals("Y")){
		...
		pw.println("<script>alert('검수 완료되었습니다.')</script>");
	}else if(msg.equals("F")){
		// 검수완료니까 alert 띄워주기
		PrintWriter pw = response.getWriter();
		pw.println("<script>alert('반려 완료되었습니다.')</script>");
	}
	// 다음 session 에서 삭제함
 		...
 		<div class="page">
  			<div class="sidebarBox">
				<div class="userNameHead">
					<h4 class="userNameTagHead" style="padding-left: 20px">관리자</h4>
					<hr>
					<div class="userNameBody">
						...
						<div class="userEmail">manager</div>
					</div>
				</div>
			</div>
