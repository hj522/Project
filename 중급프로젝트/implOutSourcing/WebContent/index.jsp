		...
		<div id="content">
			...
			<div class="box">
				<b style="margin-left: 20px; font-size: 13pt; line-height: 40pt;">
					<a href="#" style="color: rgb(32, 153, 187);">OTT 플랫폼 웹 서비스 구축</a>
				</b>
				<ul style="padding-left: 30px;">
					<li class=".bli"><img src="./images/won.png"><b>10,000,000원</b></li>
					<li class=".bli"><b style="color: rgb(232, 232, 232)">|</b><b
						style="margin-left: 30px; color: black;"><img
							src="./images/time.png">30일</b></li>
					<li class=".bli"><b style="color: rgb(232, 232, 232)">|</b><b
						style="margin-left: 30px; color: black;"><img
							src="./images/person.png">3명 지원</b></li>
				</ul>
				<br><br>
				<h6
					style="font-size: 10pt; margin-left: 20px; margin-right: 20px; color: rgb(136, 136, 136)">프로젝트 개요 :
					- 자사 콘텐츠 OTT 플랫폼 웹 서비스 구축 현재 준비 상황 :
					- 회사에서 현재 보유한 콘텐츠와 신규 제작 콘텐츠를 OTT 플랫폼에서 서비스하려고 합...</h6>
				<br>
			...
			<div class="box">
				<b style="margin-left: 20px; font-size: 13pt; line-height: 40pt;">
					<a href="#" style="color: rgb(32, 153, 187);">쇼핑몰 퍼블리싱 및 개발</a>
				</b>
				<ul style="padding-left: 30px;">
					<li class=".bli"><img src="./images/won.png"><b>20,000,000원</b></li>
					<li class=".bli"><b style="color: rgb(232, 232, 232)">|</b><b
						style="margin-left: 30px; color: black;"><img
							src="./images/time.png">30일</b></li>
					<li class=".bli"><b style="color: rgb(232, 232, 232)">|</b><b
						style="margin-left: 30px; color: black;"><img
							src="./images/person.png">4명 지원</b></li>
				</ul>
				<br><br>
				<h6
					style="font-size: 10pt; margin-left: 20px; margin-right: 20px; color: rgb(136, 136, 136)">프로젝트 개요 :
					- 새로운 모션침대 웹사이트의 브랜드사이트 겸 쇼핑몰을 만드는 프로젝트입니다 현재 준비 상황 :
					- 현재 피그마로 디자인 ....</h6>
				<br>
				<p style="margin-left: 20px;">외주(도급)</p>
			</div>
			...
			<div class="box">
				<b style="margin-left: 20px; font-size: 12pt; line-height: 40pt;">
					<a href="#" style="color: rgb(32, 153, 187);">여행사 소개 및 예약 반응형 웹 구축</a>
				</b>
				<ul style="padding-left: 30px;">
					<li class=".bli"><img src="./images/won.png"><b>12,000,000원</b></li>
					<li class=".bli"><b style="color: rgb(232, 232, 232)">|</b><b
						style="margin-left: 30px; color: black;"><img
							src="./images/time.png">30일</b></li>
					<li class=".bli"><b style="color: rgb(232, 232, 232)">|</b><b
				...
				<h6
					style="font-size: 10pt; margin-left: 20px; margin-right: 20px; color: rgb(136, 136, 136)">프로젝트 개요 :
						- 여행사 소개 및 예약 반응형 웹 구축
						현재 준비 상황 :
						- 아이디어 및 필요한 기능을 간단하게 정리해 두었습니다.
						- 미팅 시 정리된 문서 공유드릴 예정...</h6>
				<br>
				<p style="margin-left: 20px;">외주(도급)</p>
			</div>
			&nbsp;&nbsp;&nbsp;
			<div class="box">
				<b style="margin-left: 20px; font-size: 13pt; line-height: 40pt;">
					<a href="#" style="color: rgb(32, 153, 187);">Static Dicountg 제품 홍보 행사 이벤트 프로그램 디자인, 개발</a>
				</b>
				<ul style="padding-left: 30px;">
					<li class=".bli"><img src="./images/won.png"><b>11,500,000원</b></li>
					<li class=".bli"><b style="color: rgb(232, 232, 232)">|</b><b
						style="margin-left: 30px; color: black;"><img
							src="./images/time.png">30일</b></li>
					<li class=".bli"><b style="color: rgb(232, 232, 232)">할인 패스 네이티브 웹 구축</b><b
						style="margin-left: 30px; color: black;"><img
							src="./images/person.png">3명 지원</b></li>
				</ul>
				<br><br>
	...
	<div id="rev">
		...
		<div class="boxrev">
			...
			<div style="position: relative; padding-left: 120px;">
				<img src="./images/pl.png" width="130px" height="135px" style="margin-top: 35px;">
			</div>
		...
		<div class="boxrev">
			...
			<div style="position: relative; padding-left: 120px;">
				<img src="./images/aa.png" width="130px" height="135px" style="margin-top: 35px;">
			</div>
		...
		<div class="boxrev">
			...
			<div style="position: relative; padding-left: 120px;">
				<img src="./images/da.png" width="130px" height="135px" style="margin-top: 36px;">
			</div>
		...
		<div class="boxrev">
			...
			<div style="position: relative; padding-left: 120px;">
				<img src="./images/ua.png" width="133px" height="138px"  style="margin-top: 37px;">
			</div>
