...
<body>
         ...
         <div class="box">
            ...
            <div style="font-size: 13pt; padding-left: 30px; padding-top: 30px;">
               <b>프로젝트 제목</b> <b style="color: red;">*</b><br> <br> <input
                  ...
                  placeholder="예) B2B 미디어 커머스 모바일 플랫폼 구축" type="text"
            ...
            <div style="font-size: 13pt; padding-left: 30px; padding-top: 30px;">
               ...
               <div style="font-size: 8pt; padding-top: 10px;">
                  <b>해당하는 프로젝트 카테고리를 모두 선택해 주세요.</b><br> <br>
               </div>
            ...
            <hr>
            <div>
               <button onclick="f_modify()">수정 완료</button>
            </div>
         </div>
   ...
   <script>
      ...
      function f_modify(){
    	  window.location.href="projectModify.jsp";	
      }
   </script>
</body>
</html>
