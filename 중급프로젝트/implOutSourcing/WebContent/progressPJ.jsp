		...
		<div class="box">
			<div
				...
				<div style="font-size: 13pt; padding-top: 10px;">
					<b>현재 진행 중인 프로젝트를 확인할 수 있습니다.</b><br>
				</div>
			</div>
			<hr>
			<br> <br>
			<div class="guideBox">
				...
				<p style="float: left; padding-left: 8px;">
					1. 임플은 <strong>대금보호시스템</strong>을 통해 프로젝트가 완료될 때까지 <strong>대금을 안전하게 보호</strong>합니다. <br> 
					2. <strong>프로젝트 계약 관리</strong>에서 진행 중인 프로젝트의 계약 정보를 확인할 수 있습니다. <br>
					3. 프로젝트 진행 중, <strong>문제 상황이 발생하였을 시 임플 커뮤니케이션 매니저에게 문의</strong>해주세요.
					<br>&nbsp;&nbsp;&nbsp;&nbsp;문제 상황을 원활히 해결할 수 있도록 도와드립니다.
			...
			<div class="projectBox" style="float: left;">
				...
				<div class="cardRight" style="padding:30px;">
					...
					<input type="button" value="프로젝트 지원" style="width:150px;">
				</div>
			</div>
		</div>
	</form>
