...
<body>
<form action="projectInsert5.do" method="post" >
	<div>
		<div
		...
		<div class="box">
			...
			<div style="font-size: 13pt; padding-left: 30px; padding-top: 30px;">
				...
				<div style="font-size: 8pt; padding-top: 10px;">
					<b>위시켓이 클라이언트님에게 편한 미팅 방식으로 파트너와의 미팅 조율을 도와드립니다.</b><br> <br>
				</div>
				<div>
					<label> <input type="radio" name="preMeetingMethod" value="온라인" /> <span
						style="font-size: 11pt;">온라인 (카카오톡, 화상미팅 등)</span>
					</label> <br> <label> <input type="radio" name="preMeetingMethod"
						value="오프라인" /> <span style="font-size: 11pt;">오프라인</span><br>
					</label>
				</div>
			</div>
			<div style="font-size: 13pt; padding-left: 30px; padding-top: 30px;">
				...
				<div style="font-size: 10pt; padding-top: 10px;">
					<b>미팅 방식</b><b style="color: red;">*</b><br> <br>
				</div>
				<div>
					<label> <input type="radio" name="meetingMethod" value="온라인" /> <span
						style="font-size: 11pt;">온라인 (카카오톡, 화상미팅 등)</span>
				...
				<div style="font-size: 10pt; padding-top: 10px;">
					<b>미팅 주기</b><b style="color: red;">*</b><br> <br>
				</div>
				<div>
					<label> <input type="radio" name="meetingCycle" value="주 2회" /> <span
						style="font-size: 11pt;">주 2회</span>
					</label> <br> <label> <input type="radio" name="meetingCycle"
						value="주 1회" /> <span style="font-size: 11pt;">주 1회</span>
					</label><br> <label> <input type="radio" name="meetingCycle"
						value="필요시 요청" /> <span style="font-size: 11pt;">필요시
							요청</span><br>
					</label>
				</div>
			</div>
			<div style="font-size: 13pt; padding-left: 30px; padding-top: 30px;">
				...
				<div style="font-size: 8pt; padding-top: 10px;">
					<b>파트너가 미팅 위치 선정시 클라이언트님의 위치를 참고합니다.</b><br> <br>
				</div>
