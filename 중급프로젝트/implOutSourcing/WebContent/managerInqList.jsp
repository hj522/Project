...
<body>
      ...
      1:1 문의 관리<br><br><br>
         ...
         <a href="./managerInqList.do" class="btn" style="padding-left:205px; padding-right:237px;">1:1 문의</a>
         <a href="./managerInqList2.do" class="btn2" style="padding-left:207px; padding-right:220px;">답변 완료</a>
      <div>
      <table class="tbl">
          <thead class="thead">
               <tr>
