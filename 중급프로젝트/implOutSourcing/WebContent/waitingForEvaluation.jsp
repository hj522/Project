		...
		<div class="box">
			<div
				...
				<div style="font-size: 13pt; padding-top: 10px;">
					<b>더 나은 프로젝트 거래 문화를 만들어나가기 위해 파트너를 평가해주세요.</b><br>
				</div>
			</div>
			<hr>
			<br> <br>
			<div class="guideBox">
				...
				<p style="float: left; padding-left: 8px;">
					1. 프로젝트를 함께 진행했던 <strong>파트너에 대한 평가를</strong>남겨주세요.
					<br>2. 평가는 <strong>프로젝트 완료 후 14일 </strong>이내에 작성할 수 있습니다.
					<br>3. 공정하게 평가를 작성할 수 있도록 <strong>상호 평가가 완료</strong>되거나 <strong>작성기한이 종료된 뒤에 평가가 공개</strong>됩니다.
					<br>4. 평가를 완료한 뒤애는 <strong>평가의 수정이 불가능</strong>합니다. <strong>신중하게 작성</strong>해주세요.
					<br>5. 하자보수 평가는 별도 제공됩니다. <strong>[평가하기]</strong> 버튼을 눌러 제공된 평가를 완료해 주세요.
				</p>
			</div>
