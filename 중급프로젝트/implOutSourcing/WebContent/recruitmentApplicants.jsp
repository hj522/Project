		...
		<div class="box">
			<div
				...
				<div style="font-size: 13pt; padding-top: 10px;">
					<b>지원자를 모집 중인 프로젝트를 관리할 수 있습니다.</b><br>
				</div>
			</div>
			<hr>
			<br> <br>
			<div class="guideBox">
				...
				<p style="float: left; padding-left: 8px;">
					1. 지원자 모집 중인 프로젝트 목록입니다.<br> 2. <strong>[지원자 목록]</strong> 버튼을 클릭하여 지원자들의 내역을 확인할 수 있습니다.
					<br> 3. 미팅을 신청하면 서포트 매니저가 미팅 조율을 도와드립니다.
					<br> 4. 지원자 모집에 대한 문의는 <strong>고객센터</strong>로 연락 부탁드립니다.
					<br>&nbsp;&nbsp;&nbsp;&nbsp;고객센터: (042) 1234-5678 / help@implments.com
				</p>
			</div>
